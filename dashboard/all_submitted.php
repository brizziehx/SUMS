...
<body>
    ...
    <aside>
        ...
        <main>
            <header>
                <h3 class="bread-cumb"><a href="index.php">Dashboard</a> > Submitted Uniforms</h3>
            ...
            <div class="cards grid ucard">
                <div class="flex">
                    ...
                    <div class="flex">
                        <?php if($all_dimensions->num_rows > 0): ?>
                            <a href="all_submitted_dimensions.php" style="margin-right: 10px;" class="btn-view-all">View Dimensions</a>
                        <?php endif ?>
                    </div>
                </div>
                <div class="fc">
                ...
                <table class="table-u" data-excel-name="All Users" id="myTable">
                    <tbody>
                        ...
                        <?php 
                            $uniform = $conn->query("SELECT dimensions.*, uniform.* FROM dimensions INNER JOIN uniform ON dimensions.uniformID = uniform.unID WHERE dimensions.status = 'submitted'");
                            $sn = 1;
                            $status = "";
                            $em = "";
