...
<body>
    ...
    <div class="container">
        ...
        <main>
            <header>
            <h3 class="bread-cumb"><a href="index.php">Dashboard</a> > <a href="uniform.php">Uniform</a> > <a href="uni.php?department=<?=$_REQUEST['department']?>">Uniform Apps</a> > All Dimensions</h3>
            ...
            <div class="grid">
                <div class="uniform-app">
                    <form>
                        ...
                        <?php
                            $usersDep = $conn->query("SELECT user.*, department.* FROM user INNER JOIN department ON user.deptID = department.deptID WHERE department.deptName = '{$_REQUEST['department']}'"); 
